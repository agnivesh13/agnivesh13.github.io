 ...
 * Codeforces keeps its three brand colours; LeetCode inherits `currentColor`.
 */

export function CodeforcesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden {...props}>
      <rect x="1.5" y="9.75" width="5.6" height="12.25" rx="1.4" fill="#1F8ACB" />
      <rect x="9.2" y="4" width="5.6" height="18" rx="1.4" fill="#FFCA28" />
      <rect x="16.9" y="13.75" width="5.6" height="8.25" rx="1.4" fill="#F44336" />
    </svg>
  );
}
